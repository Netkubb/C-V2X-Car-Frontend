					...
					userPreferences || (userPreferences = {}),
					{
						...
						onDataChannelMessage: function (message) {
							...
							return message instanceof ArrayBuffer ||
								...
								? void connection.fbr.convertToObject(
										message,
										function (object) {
								...
								: void connection.fbr.addChunk(
										message,
										function (promptNextChunk) {
	...
	!(function (connection) {
		...
		(mPeer.onGettingLocalMedia = function (stream, callback) {
			...
			(connection.getUserMedia = connection.captureUserMedia =
				function (callback, sessionForced) {
					callback = callback || function () {};
			...
			'undefined' != typeof CodecsHandler &&
				(connection.BandwidthHandler = connection.CodecsHandler =
					CodecsHandler),
		...
		if (
			...
			(connection.checkPresence = function (roomid, callback) {
				return (
					...
					'SSEConnection' === SocketConnection.name
						? void SSEConnection.checkPresence(
								roomid,
			...
			'undefined' != typeof isChromeExtensionAvailable &&
				(connection.checkIfChromeExtensionAvailable =
